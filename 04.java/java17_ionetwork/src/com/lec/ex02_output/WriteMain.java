...
public class WriteMain {
	...
	public static void main(String[] args) throws Exception {
		...
		OutputStream os = new FileOutputStream("src/com/lec/ex02_output/test1.txt");
		...
		// 2. write(byte[] b)
		os = new FileOutputStream("src/com/lec/ex02_output/test2.txt");
		...
		os = new FileOutputStream("src/com/lec/ex02_output/test3.txt");
		data = "1234567890".getBytes();	
		os.write(data, 1, 3);
		os.flush();
		os.close();
		
		// 실습. WriteMain.java를 test4.txt로 출력해보기
