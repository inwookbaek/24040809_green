...
class SmartRemoteControl implements RemoteControl {
	
	// 1. default메서드를 재정의
	@Override
	public void powerOn() {
		System.out.println("스마트티브를 켭니다!!");
	}
...
interface Animal1 {
	String KIND = "동물";
	default void breath() { System.out.println("동물은 숨을 쉼니다!!"); };
	void sound();
	default void eat() {
		System.out.println("동물은 먹어야 삽니다!!");
	};
}

class 하이에나 implements Animal1 {
...
class Giraffe implements Animal1 {
