...
<body>
	...
	<div class="container-fluid main-container">    
      	...
      	<div class="col-sm-8 main-content text-left">
        	<form action="${ctxPath}/projectModify.do" enctype="multipart/form-data" method="post">
        		<input type="hidden" name="project_no" value="<%=article.getProjectNo()%>"/>
        		
        		<h2 style="font-weight: bold">프로젝트 수정하기</h2>
        		<br />
	...
	<script>
		$(document).ready(function() {
     		...
     		/* DB에서의 카테고리 값으로 select tag의 값을 설정 */
     		$('#category').val("<%=article.getCategory()%>");
		});
	</script>
</body>
</html>