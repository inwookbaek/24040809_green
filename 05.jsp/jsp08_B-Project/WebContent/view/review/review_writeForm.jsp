...
<body>
	...
	<div class="container-fluid text-center main-container">  
		<div class="col-sm-2"></div>  
      	<div class="col-sm-8 text-left form-group main-content">
        	<form action="review_write.do" enctype="multipart/form-data" method="post">
        		<h3 style="font-weight: bold">리뷰 등록</h3>
        		<br />
	        	<table class="table">
	        		<tr>
	        		...
	        		<tr>
	        			<td><label for="review_subject">제목</label></td>
	        			<td colspan="4">
	        				<input type="text" name="review_subject" id="subject" class="form-control input-sm" placeholder="리뷰 제목을 입력해주세요" required="required"/>
	        			</td>
	        		</tr>
	        		<tr height="500px">
	        			<td colspan="5">
	        				<textarea name="review_content" id="summernote"></textarea>
	        			</td>
	        		</tr>
	        		<tr>
	        			...
	        			<td> 
	        				<input type="submit" style="float: right; width: 60px"  value="등 록" />
	        			</td>
	        		</tr>
	        	</table>
        	</form>
