...
//    }   
    ...
    // @PreAuthorize("principal.username == #boardDTO.writer")  // #boardDTO.writer가 null로 인식을 못함 
    ...
    public String modify( PageRequestDTO pageRequestDTO,
    	...
    	log.info(String.format("board modify post....... %s, %s", writer, boardDTO));
...
//    }    
    ...
    // p675 start
    @PreAuthorize("principal.username == #writer") // 719
    @PostMapping("/remove")
    public String remove(@RequestParam(name = "writer", defaultValue = "") String writer, 
